...
class SearchExampleViewModel : ViewModel(), PositionEventListener {
    ...
    fun injectPoiSearchEngine(searchController: SearchController, searchEngine: SearchEngine) {
        searchController.injectSearchEngine(searchEngine)
    }

    override fun onLocationUpdated(vehicleLocationIn: Location, positionInfo: PositionInfo) {
