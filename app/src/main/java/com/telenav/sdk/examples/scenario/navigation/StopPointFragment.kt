...
import com.telenav.sdk.examples.databinding.FragmentNavStopPointBinding
 ...
 */
class StopPointFragment : BaseNavFragment<FragmentNavStopPointBinding>() {
    ...
    override fun getViewBinding(
        ...
        container: ViewGroup?
    ): FragmentNavStopPointBinding {
        return FragmentNavStopPointBinding.inflate(inflater, container, false)
    }
    ...
    override fun onNavigationStopReached(stopIndex: Int, stopLocation: Int) {
        ...
        if (stopIndex >= 0 && stopIndex < wayPointAnnotationList.size) {
            findMapView().annotationsController().remove(arrayListOf(wayPointAnnotationList[stopIndex]))
        }
    }
