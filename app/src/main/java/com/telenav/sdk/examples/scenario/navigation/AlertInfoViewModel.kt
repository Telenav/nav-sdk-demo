...
class AlertInfoViewModel : ViewModel() {
    ...
    var houseNumber = MutableLiveData<String>("")
...
class AlertInfoAdapter(val data: List<String>) :
    RecyclerView.Adapter<AlertInfoAdapter.CustomViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        CustomViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_alert_info, parent, false)
        )
